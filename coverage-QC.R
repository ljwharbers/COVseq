...
libraries = list.files("/mnt/AchTeraD/data/BICRO251/TN21", pattern = ".bam$", recursive = T, full.names = T)
# annot = fread("/mnt/AchTeraD/data/BICRO251/TN21-barcodes.txt", header = F)
...
save_and_plot(plot_grid(plt), "/mnt/AchTeraD/Documents/Projects/COVseq/Plots/coverage/BICRO251-TN21-55samples_reads_coverage_breadth-150se",
              height = 14, width = 14)
