...
#load primers
primers = fread("/mnt/AchTeraD/Documents/Projects/COVID19/cov2-primers/CDC-SARS-CoV-2-Primers.csv")
...
# plot genome
cairo_ps(file = paste0("/mnt/AchTeraD/Documents/Projects/COVID19/Plots/primer-pools-cairo_eps.ps"), height = 6, width = 12)
