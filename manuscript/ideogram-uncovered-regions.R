## Author: Luuk Harbers
## Date: xxxx-xx-xx
## Script for creating plot showing cutsite locations of multiple different enzymes in viral genomes
...
mse = fread("/mnt/AchTeraD/Documents/Projects/COVseq/cutsite-distribution/sars-cov-2_MseI-cutsites.bed",
            col.names = c("chr", "start", "end"))
bfa = fread("/mnt/AchTeraD/Documents/Projects/COVseq/cutsite-distribution/all-enzymes/sars-cov-2/sars-cov-2_BfaI-cutsites.bed",
            col.names = c("chr", "start", "end"))
...
bfa = makeGRangesFromDataFrame(bfa)
